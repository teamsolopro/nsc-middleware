...
const productionSchema = new mongoose.Schema(
  {
    ...
    show: {
      ...
      showType: [{
        type: String,
        enum: ['musical', 'play', 'drama', 'comedy', 'one_act', 'revue', 'concert','opera', 'operetta', 'fringe', 'immersive', 'improv', 'reading', 'childrens', 'other'],
      }],
      familyRating: { type: String, enum: ['G', 'PG', 'PG-13','18+'] },
