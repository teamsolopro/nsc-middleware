...
router.post('/submit-show', async (req, res) => {
  try {
    ...
    const production = new Production({
      ...
      tickets: {
        generalAdmission: (d.ticketPrices && d.ticketPrices.general)  || undefined,
        adult:            (d.ticketPrices && d.ticketPrices.adult)    || undefined,
        senior:           (d.ticketPrices && d.ticketPrices.senior)   || undefined,
        student:          (d.ticketPrices && d.ticketPrices.student)  || undefined,
        child:            (d.ticketPrices && d.ticketPrices.child)    || undefined,
  ...
  try {
    ...
    const audition = new Audition({
      ...
      requirements: {
        ...
        preparedReading: d.preparedReading === true || d.preparedReading === 'true',
        dance:           d.dance           === true || d.dance           === 'true',
